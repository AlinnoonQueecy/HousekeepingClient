...
@interface YHPickView ()<UIPickerViewDelegate,UIPickerViewDataSource>
...
//一组或多组数据
-(instancetype) PickviewWithPlistName:(NSString *)plistName isHaveNavControler:(BOOL)isHaveNavControler{
...
-(void)setUpDatePickerWithdatePickerMode:(UIDatePickerMode)datePickerMode{
    ...
    datePicker.backgroundColor = [UIColor colorWithWhite:1.0 alpha:0.8];
